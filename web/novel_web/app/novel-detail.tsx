...
interface NovelSummaryRangeDraft {
...
function NovelSummaryPanel(props: NovelSummaryPanelProps) {
  ...
  function handleStartEditSummary() {
    ...
    setRangeDraft(
      summary ? novelSummaryToRangeDraft(summary) : createEmptyNovelSummaryRangeDraft(),
    );
    setEditing(true);
  }
  ...
  function handleSummaryEndChapterChange(
    event: ChangeEvent<HTMLInputElement>,
  ) {
...
function NovelOutlinePanel(props: NovelOutlinePanelProps) {
...
function createEmptyNovelSummaryRangeDraft(): NovelSummaryRangeDraft {
  return {
    startChapterNumber: "0",
    endChapterNumber: "0",
  };
...
function novelSummaryToRangeDraft(
...
function parseNovelSummaryRangeDraft(
...
// 参数 summary 表示后端返回的小说滚动总结详情。
function formatNovelSummaryRange(summary: NovelSummaryItem): string {
...
function normalizeNovelSummaryChapterNumber(chapterNumber: number): number {
  return Number.isInteger(chapterNumber) && chapterNumber > 0 ? chapterNumber : 0;
}
