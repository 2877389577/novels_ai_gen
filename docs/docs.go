...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/ai/agents/chat/approval/resume": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        "description": "人工审核恢复请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler_novelagent.ChatApprovalResumeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/config/chapter-summary-agent": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "读取成功",
                        "schema": {
                            "$ref": "#/definitions/config.ChapterSummaryAgentSuccessResponse"
                        }
                    },
                    "401": {
                        "description": "未登录或登录过期",
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "章节概要 Agent 配置",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/config.UpdateChapterSummaryAgentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/novels/{novel_id}/agent-conversations/{conversation_id}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "删除成功",
                        "schema": {
                            "$ref": "#/definitions/novelagent.DeleteConversationSuccessResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
        ...
        "/novels/{novel_id}/chapters/{chapter_id}/summary": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "查询成功",
                        "schema": {
                            "$ref": "#/definitions/chapter.SummarySuccessResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "保存章节概要请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler_chapter.SummarySaveRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "aiprovider.ProviderData": {
            ...
            "properties": {
                ...
                "http_proxy": {
                    "description": "HTTPProxy 表示 AI 提供商网络请求使用的 HTTP 代理地址。",
                    "type": "string",
        ...
        "chapter.ChapterData": {
            ...
            "properties": {
                ...
                "summary": {
                    "description": "Summary 表示章节概要。",
                    "type": "string",
                    "example": "主角在雨夜发现异常脚步声，为后续冲突埋下伏笔。"
                },
                "title": {
        ...
        "chapter.ChapterSummaryDetailData": {
            "type": "object",
            "properties": {
                "chapter_number": {
                    "description": "ChapterNumber 表示章节号，即“第 x 章”中的 x。",
                ...
                "summary": {
                    "description": "Summary 表示章节概要，允许为空字符串。",
                    "type": "string",
                    "example": "主角在雨夜发现异常脚步声，为后续冲突埋下伏笔。"
                },
                "title": {
        ...
        "chapter.SummarySuccessResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "Code 表示业务响应码，成功固定为 0。",
                ...
                "data": {
                    "description": "Data 表示章节概要响应数据。",
                    "allOf": [
                        {
                            "$ref": "#/definitions/chapter.ChapterSummaryDetailData"
                        }
                    ]
                },
                "message": {
        ...
        "config.ChapterSummaryAgentData": {
            "type": "object",
            "properties": {
                "chapter_summary_agent": {
                    "description": "ChapterSummaryAgent 表示章节概要独立 Agent 配置。",
                    "type": "object"
                },
                "config_file": {
                    "description": "ConfigFile 表示启动 -f 参数指定的实际配置文件绝对路径。",
        ...
        "config.ChapterSummaryAgentSuccessResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "Code 表示业务响应码，成功固定为 0。",
                ...
                "data": {
                    "description": "Data 表示结构化章节概要 Agent 配置和加载状态。",
                    "allOf": [
                        {
                            "$ref": "#/definitions/config.ChapterSummaryAgentData"
                        }
                    ]
                },
                "message": {
        ...
        "config.UpdateChapterSummaryAgentRequest": {
            "type": "object",
            "properties": {
                "chapter_summary_agent": {
                    "description": "ChapterSummaryAgent 表示需要写入配置文件 ai.chapter_summary_agent 子树的章节概要 Agent 配置。",
                    "type": "object"
                }
            }
        },
        ...
        "internal_api_handler_aiprovider.CreateRequest": {
            ...
            "properties": {
                ...
                "http_proxy": {
                    "description": "HTTPProxy 表示 AI 提供商网络请求使用的 HTTP 代理地址，可以为空。",
                    "type": "string",
                    "example": "http://127.0.0.1:7890"
                },
                "name": {
        ...
        "internal_api_handler_chapter.CreateRequest": {
            ...
            "properties": {
                ...
                "generate_summary": {
                    "description": "GenerateSummary 表示本次创建成功后是否触发后台章节概要生成，通常只由手动保存传入。",
                    "type": "boolean",
                    "example": true
                },
                "title": {
        ...
        "internal_api_handler_chapter.SummarySaveRequest": {
            "type": "object",
            "properties": {
                "summary": {
                    "description": "Summary 表示需要保存的章节概要，允许为空字符串并保留原始空格和换行。",
                    "type": "string",
                    "example": "主角在雨夜发现异常脚步声，为后续冲突埋下伏笔。"
                }
            }
        ...
        "internal_api_handler_chapter.UpdateRequest": {
            ...
            "properties": {
                ...
                "generate_summary": {
                    "description": "GenerateSummary 表示本次更新成功后是否触发后台章节概要生成，自动保存应保持 false。",
                    "type": "boolean",
                    "example": true
                },
                "title": {
        ...
        "internal_api_handler_novelagent.ChatApprovalResumeRequest": {
            "type": "object",
            "required": [
                "checkpoint_id",
                "interrupt_id",
            ...
            "properties": {
                "approved": {
                    "description": "Approved 表示用户是否允许执行该工具。",
                    "type": "boolean",
                    "example": true
                },
                "chapter_id": {
                    "description": "ChapterID 表示待恢复请求关联的章节 ID，普通对话可为空。",
                    "type": "integer",
                    "example": 1
                },
                "chapter_number": {
                    "description": "ChapterNumber 表示待恢复请求关联的章节号，即“第 x 章”中的 x。",
                    "type": "integer",
                    "example": 3
                },
                "checkpoint_id": {
                    "description": "CheckPointID 表示 Eino ADK 中断时保存的 checkpoint 标识。",
                    "type": "string",
                    "example": "agent-approval-abc123"
                },
                "conversation_id": {
                    "description": "ConversationID 表示待恢复请求所属 Agent 会话 ID，新会话恢复时可为空。",
                    "type": "integer",
                    "example": 1
                },
                "interrupt_id": {
                    "description": "InterruptID 表示本次人工审核对应的中断点标识。",
                    "type": "string",
                    "example": "agent:supervisor;tool:get_content:call_1"
                },
                "novel_id": {
                    "description": "NovelID 表示待恢复请求关联的小说 ID。",
                    "type": "integer",
                    "example": 1
                },
                "reason": {
                    "description": "Reason 表示用户拒绝或批准时填写的补充原因。",
                    "type": "string",
                    "example": "这次允许读取章节内容"
                }
            }
        ...
        "internal_api_handler_novelagent.StreamEvent": {
            ...
            "properties": {
                "checkpoint_id": {
                    "description": "CheckPointID 表示等待人工审核时用于恢复 Agent 执行的 checkpoint 标识。",
                    "type": "string",
                    "example": "agent-approval-abc123"
                },
                "content": {
                ...
                "interrupt_id": {
                    "description": "InterruptID 表示等待人工审核时需要恢复的中断点标识。",
                    "type": "string",
                    "example": "agent:supervisor;tool:get_content:call_1"
                },
                "message": {
                ...
                "replies": {
                    "description": "Replies 表示 done 事件中返回的分段助手回复列表。",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api_handler_novelagent.StreamReply"
                    }
                },
                "reply_index": {
                    "description": "ReplyIndex 表示同一次请求中的可见助手回复段序号，从 1 开始。",
                    "type": "integer",
                    "example": 1
                },
                "request_id": {
                ...
                "run_id": {
                    "description": "RunID 表示本次 AI 对话后台运行任务 ID。",
                    "type": "string",
                    "example": "agent-run-abc123"
                },
                "stage": {
                ...
                "tool_arguments": {
                    "description": "ToolArguments 表示等待人工审核的工具调用参数 JSON 字符串。",
                    "type": "string",
                    "example": "{\"chapter_number\":3}"
                },
                "tool_name": {
                    "description": "ToolName 表示等待人工审核的工具名称。",
                    "type": "string",
                    "example": "get_content"
                },
                "type": {
                    "description": "Type 表示事件类型，支持 meta、delta、approval_required、done、error。",
                    "type": "string",
                    "example": "delta"
                }
            }
        },
        "internal_api_handler_novelagent.StreamReply": {
            "type": "object",
            "properties": {
                "content": {
                    "description": "Content 表示该回复段的完整文本内容。",
                    "type": "string",
                    "example": "我先读取当前章节内容。"
                },
                "reply_index": {
                ...
                "task": {
                    "description": "Task 表示产生该回复段的任务来源。",
                    "type": "string",
                    "example": "polish"
                }
            }
        ...
        "novelagent.DeleteConversationData": {
            "type": "object",
            "properties": {
                "deleted": {
                    "description": "Deleted 表示 Agent 会话是否已经删除。",
                    "type": "boolean",
                    "example": true
                }
            }
        },
        "novelagent.DeleteConversationSuccessResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "Code 表示业务响应码，成功固定为 0。",
                ...
                "data": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/novelagent.DeleteConversationData"
                        }
                    ]
                },
                "message": {
