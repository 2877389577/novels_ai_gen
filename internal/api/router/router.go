...
func NewRouter(authHandler *authhandler.Handler, novelHandler *novelhandler.Handler, chapterHandler *chapterhandler.Handler, characterHandler *characterhandler.Handler, relationshipHandler *relationshiphandler.Handler, eventHandler *eventhandler.Handler, aiProviderHandler *aiproviderhandler.Handler, novelAgentHandler *novelagenthandler.Handler, novelSummaryHandler *novelsummaryhandler.Handler, novelOutlineHandler *noveloutlinehandler.Handler, promptHandler *prompthandler.Handler, uploadHandler *uploadhandler.Handler, configHandler *confighandler.Handler, logHandler *loghandler.Handler, systemHandler *systemhandler.Handler, authService *bizauth.Service) *gin.Engine {
	...
	protected.POST("/novels/:id/summary", novelSummaryHandler.Create)
	...
	protected.GET("/novels/:id/chapters/:chapter_id/summary", chapterHandler.GetSummary)
	protected.PUT("/novels/:id/chapters/:chapter_id/summary", chapterHandler.SaveSummary)
	protected.DELETE("/novels/:id/chapters/:chapter_id/summary", chapterHandler.DeleteSummary)
	...
	protected.GET("/ai/agents/chat/runs/:run_id/stream", novelAgentHandler.StreamRun)
	protected.POST("/ai/agents/chat/runs/:run_id/stop", novelAgentHandler.StopRun)
	...
	protected.GET("/config/chapter-summary-agent", configHandler.GetChapterSummaryAgent)
	protected.PUT("/config/chapter-summary-agent", configHandler.UpdateChapterSummaryAgent)
	protected.GET("/novels/:id/agent-conversations", novelAgentHandler.ListConversations)
	protected.GET("/novels/:id/agent-runs", novelAgentHandler.ListRuns)
	protected.DELETE("/novels/:id/agent-conversations/:conversation_id", novelAgentHandler.DeleteConversation)
